...
import ru.otus.otuskotlin.yan.swiftorder.biz.repo.repoCreate
import ru.otus.otuskotlin.yan.swiftorder.biz.stubs.stubCreateSuccess
...
fun ICorChainDsl<Context>.orderCreate() = operation(Command.CREATE) {
    stubs {
        stubCreateSuccess()
